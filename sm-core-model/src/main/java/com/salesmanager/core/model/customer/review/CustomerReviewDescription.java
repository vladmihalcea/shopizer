...
@SequenceGenerator(name = "description_gen", sequenceName = "custome_review_description_seq", allocationSize = SchemaConstant.DESCRIPTION_ID_ALLOCATION_SIZE, initialValue = SchemaConstant.DESCRIPTION_ID_START_VALUE)
...
public class CustomerReviewDescription extends Description {
	...
	@ManyToOne(targetEntity = CustomerReview.class, fetch = FetchType.LAZY)
