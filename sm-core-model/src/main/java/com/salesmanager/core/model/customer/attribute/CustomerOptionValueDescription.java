...
@SequenceGenerator(name = "description_gen", sequenceName = "customer_option_value_description_seq", allocationSize = SchemaConstant.DESCRIPTION_ID_ALLOCATION_SIZE, initialValue = SchemaConstant.DESCRIPTION_ID_START_VALUE)
...
public class CustomerOptionValueDescription extends Description {
	...
	@JsonIgnore
	@ManyToOne(targetEntity = CustomerOptionValue.class, fetch = FetchType.LAZY)
